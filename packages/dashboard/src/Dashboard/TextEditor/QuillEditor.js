...
export const QuillEditor = defineComponent({
  ...
  setup: (props, ctx) => {
    ...
    const getToolbar = () => {
      var _a
      return (_a = quill === null || quill === void 0 ? void 0 : quill.getModule('toolbar')) ===
        null || _a === void 0
        ? void 0
        : _a.container
    }
    ...
    const getText = (index, length) => {
      var _a
      return (_a = quill === null || quill === void 0 ? void 0 : quill.getText(index, length)) !==
        null && _a !== void 0
        ? _a
        : ''
    }
    ...
    const getHTML = () => {
      var _a
      return (_a = quill === null || quill === void 0 ? void 0 : quill.root.innerHTML) !== null &&
        _a !== void 0
        ? _a
        : ''
    }
    ...
    const pasteHTML = (html, source = 'api') => {
      ...
      if (delta) quill === null || quill === void 0 ? void 0 : quill.setContents(delta, source)
    }
    const focus = () => {
    ...
    watch(
      ...
      (newContent) => {
        ...
        if (selection) {
          nextTick(() =>
            quill === null || quill === void 0 ? void 0 : quill.setSelection(selection)
          )
        }

...
const buttonTypeClasses = computed(() => ({
  primary: !props.isTransparent
    ? "border border-oc-primary oc-btn-primary text-oc-text-000"
  ...
  destructive: !props.isTransparent
    ? "border border-oc-error oc-btn-error text-oc-text-000"
...
.oc-btn {
  ...
  &-add-area {
    &.primary {
      ...
      @apply border-[var(--oc-accent-3-500)] text-oc-text-000;
      &:hover {
    ...
    &.destructive {
      ...
      @apply border-[var(--oc-error-500)] text-oc-text-000;

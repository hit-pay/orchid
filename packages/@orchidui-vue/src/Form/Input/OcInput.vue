      ...
      <div class="flex flex-1 items-baseline gap-x-2">
        ...
        <div class="flex items-center gap-x-1 w-full">
          ...
          <input
            ...
            :disabled="disabled"
            class="h-7 outline-none w-full text-oc-text disabled:bg-transparent disabled:text-oc-text-300 placeholder:font-normal placeholder:text-oc-text-300 bg-oc-bg-light"

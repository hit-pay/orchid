...
<template>
  <div
    class="whitespace-nowrap text-start md:uppercase text-oc-text-400 md:leading-[18px] leading-[12px] text-[.5rem] md:text-xs font-medium bg-oc-gray-50 flex items-center gap-3"

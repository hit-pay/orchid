import { defineComponent as Re, ref as j, onMounted as re, openBlock as r, createBlock as D, unref as i, withCtx as P, createElementVNode as B, createElementBlock as $, createVNode as K, mergeProps as ke, Fragment as J, renderList as ae, normalizeClass as te, toDisplayString as he, createCommentVNode as F, computed as A, createSlots as Me, renderSlot as Y, normalizeProps as xe, guardReactiveProps as we, withKeys as Ne, nextTick as qe } from "vue";
import { Dropdown as Se, Icon as $e, Checkbox as ze, Button as W, Table as He, Tabs as Ge, Pagination as Je, PrevNext as Oe, Select as We, Input as Xe, TableHeader as Ze, Chip as se } from "@orchidui/vue-core";
import oe from "dayjs";
import { VueDraggableNext as Fe } from "vue-draggable-next";
import { getFromLocalStorage as je, formatHeadersFromLocalStorage as Ve, formatHeadersToLocalStorage as _e, setInLocalStorage as el } from "./Builder/DataTable/utils/editColumnsUtils.js";
import { _ as ll } from "./OcFormBuilder-CHFkYfBl.js";
const al = { class: "p-5 gap-y-4 text-sm flex w-[250px] flex-col" }, tl = {
...
}, rl = { class: "flex items-center w-full gap-x-3" }, nl = { class: "truncate w-full max-w-[160px]" }, ul = /* @__PURE__ */ Re({
  __name: "ColumnEdit",
  props: {
    options: {
      type: Object,
  ...
  setup(y, { emit: T }) {
    const g = T, c = y, s = j([]), v = j([]), p = j(!1), u = (a = !1) => {
      ...
      menu: P(() => [
        B("div", al, [
          v.value.length ? (r(), $("div", tl, [
            f[4] || (f[4] = B("span", { class: "text-oc-text-400 font-medium" }, "Fixed columns", -1)),
            K(i(Fe), ke({
              key: "key",
              modelValue: v.value,
          ...
          B("div", sl, [
            f[5] || (f[5] = B("span", { class: "text-oc-text-400 font-medium" }, "Active columns", -1)),
            K(i(Fe), ke({
              key: "key",
              modelValue: s.value,
  ...
  setup(y, { emit: T }) {
    ...
    const g = y, c = T, s = A(() => {
      ...
      return {
        ...u.value,
        headers: p.value ? p.value.filter((e) => ue(e.key)) : (l = u.value) == null ? void 0 : l.headers.filter((e) => ue(e.key))
      };
    }), a = A(() => {
      var l;
    ...
    ), G = ((ge = g.filter[(ye = (me = a.value) == null ? void 0 : me.search) == null ? void 0 : ye.key]) == null ? void 0 : ge.trim()) ?? "", M = j(G ? G.split(",") : []), ne = j(!1), Ee = A(
      () => {
        var l, e;
    ...
    const n = j(z), Ke = () => {
      ...
      M.value = [];
      const l = {};
      a.value ? z.page = 1 : z.cursor = "", (d = (e = a.value) == null ? void 0 : e.per_page) != null && d.key ? l[(O = (h = a.value) == null ? void 0 : h.per_page) == null ? void 0 : O.key] = C.value : l.per_page = C.value, (t = (w = a.value) == null ? void 0 : w.tabs) != null && t.key ? l[(U = (V = a.value) == null ? void 0 : V.tabs) == null ? void 0 : U.key] = m.value : l.tabs = m.value, n.value = l, I();
    }, Ue = () => {
      I(null, k.value);
    }, I = (l = null, e = !1, d = "") => {
      var h, O, w;
      s.value && !e && (k.value = 1), s.value ? n.value.page = k.value : n.value.cursor = d, (h = a.value) != null && h.per_page ? n.value[a.value.per_page.key] = C.value : n.value.per_page = C.value, (O = a.value) != null && O.tabs && (n.value[a.value.tabs.key] = m.value), (w = a.value) != null && w.search && (n.value[a.value.search.key] = M.value.join()), l && (S.value = !1, n.value = { ...n.value, ...l }, Object.keys(n.value).forEach((t) => {
        Array.isArray(n.value[t]) && n.value[t].length === 0 && delete n.value[t];
      })), c("update:filter", n.value);
    }, Be = (l, e) => {
      ...
      if (n.value) {
        let l = [];
        return Object.keys(n.value).forEach((e) => {
          var w, t, V, U, H, N, X, Z, _, ee, le;
          let d = (t = (w = a.value) == null ? void 0 : w.tabs) == null ? void 0 : t.key;
          const h = (U = (V = a.value) == null ? void 0 : V.search) == null ? void 0 : U.key, O = ((N = (H = a.value) == null ? void 0 : H.per_page) == null ? void 0 : N.key) ?? "per_page";
          if ((X = a.value.form) == null || X.find((E) => {
            ...
            if (b && n.value[e]) {
              if (typeof b.name == "object" ? (_ = b.name) == null || _.forEach((Q) => {
                L && (L += " - "), L += n.value[Q.key];
              }) : L = n.value[e], b.props.options && (L = (b.props.multiple ? n.value[e] : [n.value[e]]).map(
                (q) => {
                  var be;
                  return (be = b.props.options.find(({ value: Te }) => Te === q)) == null ? void 0 : be.label;
                }
              ).join(", ")), b.type === "RangeInput" && Array.isArray(n.value[e]) && (L = n.value[e][0].toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") + " - " + n.value[e][1].toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")), b.type === "DatePicker")
                if (((ee = b == null ? void 0 : b.props) == null ? void 0 : ee.type) === "range" && b.name && b.name[1]) {
                  const Q = oe(n.value[b.name[0].key]).format("MM/DD/YYYY"), q = oe(n.value[b.name[1].key]).format("MM/DD/YYYY");
                  L = Q === q ? Q : Q + " - " + q;
                } else L = oe(n.value[b.name]).format("MM/DD/YYYY");
      ...
      var e, d, h, O, w, t;
      return ((t = (w = (O = (h = n.value) == null ? void 0 : h[(d = (e = a.value) == null ? void 0 : e.columnEdit) == null ? void 0 : d.key]) == null ? void 0 : O.active) == null ? void 0 : w.find((V) => V.key === l)) == null ? void 0 : t.isActive) ?? !0;
    }, Ie = ({ fixedHeaders: l, activeHeaders: e, isOnMount: d }) => {
      var h, O, w, t;
      if (n.value[(O = (h = a.value) == null ? void 0 : h.columnEdit) == null ? void 0 : O.key].fixed = l, n.value[(t = (w = a.value) == null ? void 0 : w.columnEdit) == null ? void 0 : t.key].active = e, p.value = [...l, ...e], !d) {
        const V = _e(l, e);
        el(a.value.columnEdit.localStorageKey, V);
      }
    }, Qe = () => {
      var l, e, d, h, O, w;
      if ((e = (l = a.value) == null ? void 0 : l.columnEdit) != null && e.localStorageKey) {
        ...
        if (t) {
          const { fixed: V, active: U } = Ve(
            t,
            u.value.headers,
            a.value.columnEdit.localStorageKey
          );
          n.value[(h = (d = a.value) == null ? void 0 : d.columnEdit) == null ? void 0 : h.key].fixed = V, n.value[(w = (O = a.value) == null ? void 0 : O.columnEdit) == null ? void 0 : w.key].active = U, p.value = [...V, ...U];
        }
      }
    };
    return re(() => {
        ...
        u.value ? (r(), D(i(He), {
          ...
          l.$slots.before || (d = a.value) != null && d.search || (h = a.value) != null && h.form || (O = a.value) != null && O.tabs ? {
            ...
            fn: P(() => {
              ...
              return [
                Y(l.$slots, "before"),
                (t = a.value) != null && t.search || (V = a.value) != null && V.form || (U = a.value) != null && U.tabs ? (r(), $("div", dl, [
                  Ae.value ? (r(), $("div", vl, [
                    ...
                    return [
                      (N = a.value) != null && N.search || (X = a.value) != null && X.form || (Z = a.value) != null && Z.columnEdit ? (r(), $("div", {
                        ...
                        class: te([
                          ...
                          a.value ? ne.value ? "md:w-fit w-full" : "" : "w-full justify-end"
                        ])
                      }, [
                        ...
                        a.value.columnEdit ? (r(), D(ul, {
                          key: 2,
                          options: n.value.columnEdit,
                          headers: ((le = u.value) == null ? void 0 : le.headers) || [],
          ...
          ae((w = u.value) == null ? void 0 : w.headers, (t, V) => ({
            name: t.key,
            fn: P(({ data: U, item: H }) => [
              Y(l.$slots, t.key, {
                data: U,
      ...
      B("div", {
        ...
        B("div", ml, [
          K(i(Xe), {
            ...
            onKeyup: o[1] || (o[1] = Ne(
              () => {
                u.$emit("addQuery", s.value), s.value = "";
              },
              ["enter"]
            ))
          }, null, 8, ["modelValue"]),
          y.isSearchOnly ? (r(), D(i(W), {
            ...
            onClick: o[3] || (o[3] = () => {
              c.value = !1, u.$emit("toggle", c.value), s.value = "";
            })
          }, " Clear "))
        ])
      ], 2),
  ...
  setup(y, { emit: T }) {
    const g = y, c = T, s = A(() => {
      var u;
      let p = [];
      return (u = g.filters) == null || u.forEach((o) => {
        if (o.multiNames) {
    ...
    return (p, u) => s.value.length > 0 || y.queries.length > 0 ? (r(), D(i(Ze), {
      key: 0,
      class: "!w-full !justify-start !bg-oc-bg-light"
    }, {
      default: P(() => [
        B("div", gl, [
          u[1] || (u[1] = B("span", { class: "pr-2 text-sm font-medium text-oc-text" }, "Search for:", -1)),
          ...
          K(i(se), {
            ...
            label: "Clear all",
            onClick: u[0] || (u[0] = (o) => p.$emit("removeAll"))
          })
        ])
      ]),
      _: 1

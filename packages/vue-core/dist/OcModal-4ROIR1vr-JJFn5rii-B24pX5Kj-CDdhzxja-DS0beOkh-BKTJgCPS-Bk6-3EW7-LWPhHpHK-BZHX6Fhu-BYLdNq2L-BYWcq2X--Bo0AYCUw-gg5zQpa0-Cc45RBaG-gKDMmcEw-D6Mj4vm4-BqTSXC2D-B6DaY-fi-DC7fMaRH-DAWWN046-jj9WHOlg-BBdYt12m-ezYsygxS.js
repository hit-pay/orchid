import { computed as C, ref as V, watch as S, onUnmounted as z, openBlock as o, createElementBlock as s, createElementVNode as a, normalizeClass as c, renderSlot as p, toDisplayString as v, createCommentVNode as r, createVNode as m, unref as f, mergeProps as b } from "vue";
import "dayjs";
import { B as $, c as g } from "./Cropper-Qy54pgCV.js";
...
}, P = { class: "flex flex-col gap-y-1 overflow-hidden" }, j = { class: "text-lg font-medium text-ellipsis overflow-hidden whitespace-nowrap" }, E = {
  key: 0,
    ...
    return S(
      ...
      a("div", {
        ...
        e.isHeaderVisible ? (o(), s("div", {
          ...
          p(l.$slots, "header", {}, () => [
            a("div", P, [
              a("span", j, v(e.title), 1),
              p(l.$slots, "description", {}, () => [
                e.description ? (o(), s("span", E, v(e.description), 1)) : r("", !0)
              ])
            ]),

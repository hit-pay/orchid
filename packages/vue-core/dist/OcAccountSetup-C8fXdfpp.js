import { openBlock as t, createElementBlock as a, normalizeClass as n, Fragment as b, renderList as w, createBlock as g, unref as p, createCommentVNode as o, renderSlot as m, ref as A, reactive as L, computed as U, onMounted as W, createElementVNode as i, toDisplayString as S, withCtx as k, createVNode as y, normalizeProps as P, guardReactiveProps as M, normalizeStyle as $ } from "vue";
import "dayjs";
import { m as D } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { g as O } from "./OcIcon-CJgBICxh-Cknfoj_m.js";
import { o as F } from "./OcDropdownItem-CzffqBjG-CMBrNq8k.js";
import { _ as N } from "./OcIcon-CJgBICxh.js";
import { _ as V } from "./OcChip-B020X1Ok.js";
...
const j = {
  ...
  setup(e) {
    return (f, d) => (t(), a("div", {
      ...
      (t(!0), a(b, null, w(e.menu.children, (r, v) => (t(), a("div", {
        key: v,
        class: n(["text-oc-text-400 flex items-center rounded hover:bg-[var(--oc-sidebar-menu-hover)]", {
          "font-medium bg-[var(--oc-sidebar-menu-active)] text-[var(--oc-sidebar-menu-active-text)]": r.active
        }])
      }, [
        e.isExpandedSidebar ? (t(), g(p(D), {
          ...
          class: n(["flex z-[1] ml-[17.5px]", {
            "text-[var(--oc-sidebar-menu-active-icon)]": !r.active,
            "text-[var(--oc-sidebar-menu-active-icon-active)]": r.active
          }]),
    ...
    return W(() => {
      ...
      i("div", T, [
        ...
        (t(!0), a(b, null, w(e.sidebarMenu, (h, C) => (t(), a(b, { key: C }, [
          e.isExpanded && h.label ? (t(), a("h2", q, S(h.label), 1)) : o("", !0),
...
}, we = /* @__PURE__ */ R(re, [["__scopeId", "data-v-98a72f05"]]);
export {
  we as O,
  Ee as _,
  ke as a

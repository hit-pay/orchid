...
import "dayjs";
import { aA as A, aB as L } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { m as S } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq.js";
import "echarts";
  ...
  setup(m, { expose: w }) {
    ...
    return w({
      ...
      m.showLegend ? (t(), a("div", N, [
        (t(!0), a(l, null, f(p.value.series[0].data, (e) => (t(), h(x(A), {
          key: e.name,
          position: "top",

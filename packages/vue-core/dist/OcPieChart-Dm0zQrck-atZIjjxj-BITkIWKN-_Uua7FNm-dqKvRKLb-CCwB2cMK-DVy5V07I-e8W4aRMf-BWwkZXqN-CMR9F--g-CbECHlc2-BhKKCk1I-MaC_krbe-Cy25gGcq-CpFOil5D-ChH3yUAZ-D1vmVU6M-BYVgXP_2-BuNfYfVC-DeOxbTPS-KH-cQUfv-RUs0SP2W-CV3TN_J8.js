import { computed as b, ref as F, openBlock as t, createElementBlock as a, createElementVNode as n, Fragment as i, renderList as f, createBlock as h, unref as x, withCtx as y, normalizeClass as C, normalizeStyle as T, toDisplayString as s, createTextVNode as g, createCommentVNode as A } from "vue";
import "dayjs";
import { k as B, A as L } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { m as V } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq.js";
import "echarts";
  ...
  setup(m, { expose: w }) {
    ...
    return w({
      ...
      m.showLegend ? (t(), a("div", O, [
        (t(!0), a(i, null, f(p.value.series[0].data, (e) => (t(), h(x(B), {
          key: e.name,
          position: "top",

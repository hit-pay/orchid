import { ref as y, watch as P, nextTick as H, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as Y, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as I, createSlots as K, normalizeClass as k, renderSlot as B, mergeProps as N, toDisplayString as D, withModifiers as Q, renderList as X, normalizeProps as ee } from "vue";
import "dayjs";
import { y as R, C as W, w as te, Y as le, D as G, A as q, v as ae, $ as F, _ as oe } from "./Cropper-Qy54pgCV.js";
    ...
    return (v, m) => (l(), p(o(G), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(Y, null, X(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
    ...
    return (i, t) => {
      ...
      return l(), b("div", he, [
        ...
        g("div", xe, [
          ...
          (L = e.inputOptions) != null && L.includes("link") ? (l(), p(o(M), {
            key: 1,
          ...
          g("div", null, [
            ...
            (A = e.inputOptions) != null && A.includes("caption") && z.value ? (l(), p(o(M), {
              key: 1,
          ...
          g("div", null, [
            (E = e.inputOptions) != null && E.includes("lightbox") ? (l(), p(o(W), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

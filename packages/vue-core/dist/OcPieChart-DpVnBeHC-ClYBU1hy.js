...
import "dayjs";
import { m as O } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { M as S } from "./OcTooltip-DBif_2H1-B-R8nPrI-BM5y6FC0.js";
import { p as V } from "./useChart-D7VZPAAA.js";
import "echarts";
const $ = { class: "flex flex-col items-center" }, A = {
  key: 0,
  class: "flex gap-x-5"
}, L = ["onClick"], N = {
  key: 1,
  class: "text-sm font-medium text-oc-text-500"
}, _ = { class: "py-2 text-sm text-oc-text-400 font-medium px-3 w-max" }, H = {
  __name: "OcPieChart",
  props: {
    showTooltip: Boolean,
    showLegend: Boolean,
  ...
  setup(p, { expose: w }) {
    ...
    return w({
      ...
      p.showLegend ? (t(), a("div", A, [
        (t(!0), a(l, null, f(m.value.series[0].data, (e) => (t(), h(x(S), {
          key: e.name,
          position: "top",

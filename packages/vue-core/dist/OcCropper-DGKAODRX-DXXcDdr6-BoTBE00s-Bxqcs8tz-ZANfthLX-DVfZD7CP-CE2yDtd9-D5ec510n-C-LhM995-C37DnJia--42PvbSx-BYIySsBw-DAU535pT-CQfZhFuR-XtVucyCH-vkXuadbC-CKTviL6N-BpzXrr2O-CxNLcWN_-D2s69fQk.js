import { ref as y, watch as W, nextTick as K, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Q, computed as I, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as L, toDisplayString as M, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { i as C, j as q, _ as te, $ as le, k as H, g as E, f as ae, B as F, b as oe } from "./Cropper-Qy54pgCV.js";
    ...
    return (i, t) => {
      ...
      return l(), b("div", he, [
        ...
        g("div", xe, [
          ...
          g("div", null, [
            (N = e.inputOptions) != null && N.includes("caption") ? (l(), p(o(q), {
              key: 0,
              modelValue: z.value,
          ...
          g("div", null, [
            (A = e.inputOptions) != null && A.includes("lightbox") ? (l(), p(o(q), {
              key: 0,
              modelValue: T.value,
              "onUpdate:modelValue": [

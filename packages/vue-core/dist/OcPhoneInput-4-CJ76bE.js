import { ref as y, computed as E, openBlock as g, createBlock as w, unref as s, withCtx as m, createVNode as C, createElementVNode as a, withModifiers as v, createElementBlock as L, Fragment as K, renderList as D, normalizeClass as h, toDisplayString as M } from "vue";
import "dayjs";
import "./Cropper-Qy54pgCV.js";
import { parsePhoneNumber as k } from "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { g as G } from "./OcIcon-CJgBICxh-Cknfoj_m.js";
import { d as N } from "./OcInputOption-D9DTYAD7-BrCoHHb9.js";
import { o as U } from "./OcDropdownItem-lmVCX47e-KIMNJ0NG.js";
import { preventEventIfNotNumberInput as O } from "./composables/helpers.js";
const F = [
...
], H = { class: "flex gap-x-2 items-center" }, Z = { class: "text-oc-text-400 font-medium text-sm" }, z = { class: "px-3 py-1 sticky top-0 bg-oc-bg-light z-[1000]" }, J = ["onClick"], W = { class: "text-oc-text-300" }, Y = { class: "text-oc-text-400" }, ro = {
  __name: "OcPhoneInput",
  props: {
  ...
  setup(n, { emit: V }) {
    const t = n, u = V;
    let b = t.initialCountryCode;
    if (t.modelValue && t.modelValue[0]) {
      const e = t.countryCodes.find((o) => o.code === t.modelValue[0].toString());
      e && (b = e.iso.toLowerCase());
    }
    const i = y(b), S = y(!1), p = y(""), f = E(
      () => t.countryCodes.filter((e) => e.country.toLowerCase().includes(p.value.toLowerCase())).sort((e, o) => e.country.localeCompare(o.country))
      ...
      var c;
      i.value = e.toLowerCase(), u("update:modelValue", [o, r || ((c = t.modelValue) == null ? void 0 : c[1]) || ""]), S.value = !1;
    }, T = y(null), A = y([]), P = () => {
      setTimeout(() => {
        const e = f.value.indexOf(
          I(i.value)
      ...
      try {
        if (o.search(/[^0-9]/g) < 0)
          if (o = o.slice(0, 19), o.length > 5 && t.shouldParseCountryCode) {
            const { nationalNumber: r, countryCallingCode: c, country: l } = k(
              "+" + o.replace("+", "")
            );
          ...
          C(s(U), {
            ...
            menu: m(() => [
              a("div", {
                ...
                (g(!0), L(K, null, D(f.value, (c, l) => (g(), L("div", {
                  ref_for: !0,

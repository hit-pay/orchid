import { ref as y, watch as q, nextTick as H, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as I, createSlots as K, normalizeClass as k, renderSlot as B, mergeProps as M, toDisplayString as D, withModifiers as Q, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { ad as R, ae as E, ab as te, ac as ae, af as X, a7 as A, aa as le, a2 as F, a1 as oe } from "./Cropper-CtPTheuH.js";
        ...
        g("div", {
          ...
          s.$slots.leading || C.value ? (a(), b("div", {
            ...
            s.$slots.leading ? r("", !0) : (a(), b("span", {
              ...
              onClick: u[4] || (u[4] = Q((h) => v.value = !v.value, ["prevent"]))
            }, [
              (a(), p(o(A), {
                key: v.value,
  ...
  setup(e, { emit: f }) {
    ...
    return (i, t) => {
      ...
      return a(), b("div", he, [
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (a(), p(o(L), {
            key: 0,
          ...
          (U = e.inputOptions) != null && U.includes("link") ? (a(), p(o(L), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (a(), p(o(E), {
              key: 0,
              modelValue: z.value,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (a(), p(o(L), {
              key: 1,
            ...
            (P = e.inputOptions) != null && P.includes("caption") && z.value ? (a(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (W = e.inputOptions) != null && W.includes("lightbox") ? (a(), p(o(E), {
              key: 0,
              modelValue: N.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (l) => N.value = l),

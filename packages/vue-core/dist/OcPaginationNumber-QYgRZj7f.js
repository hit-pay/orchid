...
import "dayjs";
import { m as P } from "./Cropper-Qy54pgCV.js";
...
}, w = { class: "w-full items-center flex relative" }, B = { class: "flex items-center gap-x-6" }, S = { class: "hidden md:flex items-center gap-x-3" }, $ = { class: "md:hidden mx-[30px]" }, E = {
  __name: "OcPagination",
  props: {
    maxPage: {
      type: [String, Number],

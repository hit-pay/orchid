import { ref as y, watch as E, nextTick as H, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as K, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as I, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as M, toDisplayString as D, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { K as C, Q as P, g as te, B as le, p as Q, L as W, e as ae, d as F, o as oe } from "./Cropper-CtPTheuH.js";
    ...
    return (v, m) => (l(), p(o(Q), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(K, null, Z(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
    ...
    return (i, t) => {
      ...
      return l(), b("div", he, [
        ...
        g("div", xe, [
          ...
          g("div", null, [
            (U = e.inputOptions) != null && U.includes("caption") ? (l(), p(o(P), {
              key: 0,
              modelValue: z.value,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (l(), p(o(L), {
              key: 1,

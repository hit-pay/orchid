...
import "dayjs";
import { G as C, H as F, E as te, F as le, I as H, Y as P, D as ae, A as W, o as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
  ...
  setup(e, { emit: f }) {
    ...
    }, I = y(!!d.value.caption), N = y(!!d.value.lightbox);
    return (i, t) => {
      var O, U, T, A, E, j;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          (U = e.inputOptions) != null && U.includes("link") ? (l(), p(o(L), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (l(), p(o(F), {
              key: 0,
              modelValue: I.value,
            ...
            (A = e.inputOptions) != null && A.includes("caption") && I.value ? (l(), p(o(L), {
              key: 1,
          ...
          g("div", null, [
            (j = e.inputOptions) != null && j.includes("lightbox") ? (l(), p(o(F), {
              key: 0,
              modelValue: N.value,
              "onUpdate:modelValue": [

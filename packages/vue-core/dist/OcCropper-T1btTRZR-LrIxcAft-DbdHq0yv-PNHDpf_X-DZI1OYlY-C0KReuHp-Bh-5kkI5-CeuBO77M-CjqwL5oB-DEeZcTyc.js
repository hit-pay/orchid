import { ref as y, watch as W, nextTick as H, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as I, createSlots as K, normalizeClass as k, renderSlot as B, mergeProps as L, toDisplayString as D, withModifiers as X, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { ai as C, aj as q, ag as te, ah as ae, ak as Q, ac as A, af as le, a7 as E, a6 as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
    ...
    return (s, u) => (a(), p(o(Q), {
      ...
      default: V(() => [
        g("div", {
          ...
          s.$slots.leading || R.value ? (a(), b("div", {
            key: 1,
            class: k({
  ...
  setup(e, { emit: f }) {
    ...
    }, $ = y(!!d.value.caption), N = y(!!d.value.lightbox);
    return (i, t) => {
      var O, T, U, j, P, F;
      return a(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          g("div", null, [
            ...
            (P = e.inputOptions) != null && P.includes("caption") && $.value ? (a(), p(o(ve), {
              key: 2,

import { ref as y, watch as A, nextTick as K, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as u, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Q, computed as I, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as N, toDisplayString as D, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { an as R, ao as E, al as te, am as ae, ap as J, ah as W, ak as le, ac as F, ab as oe } from "./Cropper-CtPTheuH.js";
...
const ne = {
...
}, pe = { class: "flex items-center gap-x-1 w-full" }, ue = {
  key: 0,
  class: "text-oc-text-300"
}, de = ["value", "readonly", "placeholder", "disabled", "autocomplete", "inputmode", "type"], M = {
  __name: "OcInput",
  props: {
    disabled: {
      type: Boolean,
  ...
  setup(e, { expose: f }) {
    ...
    const m = y(!1), c = I(() => [
      ...
      const { class: s, ...p } = S, h = {};
      return n.pattern && (h.pattern = n.pattern), { inputAttributes: h, ...p };
    ...
    return (s, p) => (a(), u(o(J), {
      ...
      default: V(() => [
        g("div", {
          ...
          g("div", re, [
            e.isInlineLabel && e.label ? (a(), b("label", se, D(e.label) + ": ", 1)) : r("", !0),
            g("div", pe, [
              e.preFill ? (a(), b("span", ue, D(e.preFill), 1)) : r("", !0),
              g("input", N({
                ref_key: "inputRef",
                ref: x,
                value: e.modelValue,
                ...
                onInput: p[2] || (p[2] = (h) => s.$emit("update:modelValue", h.target.value)),
                onPaste: p[3] || (p[3] = (h) => s.$emit("paste"))
              }), null, 16, de)
            ])
          ]),
          s.$slots.leading || C.value ? (a(), b("div", {
            ...
            s.$slots.leading ? r("", !0) : (a(), b("span", {
              ...
              onClick: p[4] || (p[4] = Y((h) => v.value = !v.value, ["prevent"]))
            }, [
              (a(), u(o(W), {
                key: v.value,
    ...
    return (f, n) => (a(), u(o(le), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (a(), u(o(oe), ee(N({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
              B(f.$slots, "tooltipText", {}, () => [
                e.tooltipText ? (a(), b("div", ge, D(e.tooltipText), 1)) : r("", !0)
              ])
            ]),
            default: V(() => [
              w(o(F), {
    ...
    return (v, m) => (a(), u(o(J), {
      ...
      default: V(() => [
        g("div", {
          ...
          (a(!0), b(G, null, Z(e.radio, (c, d) => (a(), u(o(be), {
            id: c.value,
            key: d,
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, Ce = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    return (i, t) => {
      ...
      return a(), b("div", he, [
        ...
        g("div", fe, [
          m.value ? (a(), b(G, { key: 0 }, [
            ...
            w(o(R), {
              ...
              size: "small",
              "left-icon": "zoom-out",
              onClick: t[1] || (t[1] = (l) => p(0.8))
            }),
            w(o(R), {
              variant: "secondary",
              size: "small",
              "left-icon": "zoom-in",
              onClick: t[2] || (t[2] = (l) => p(1.2))
            }),
            w(o(R), {
              variant: "secondary",
              size: "small",
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (a(), u(o(M), {
            key: 0,
          ...
          (L = e.inputOptions) != null && L.includes("link") ? (a(), u(o(M), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (a(), u(o(E), {
              key: 0,
              modelValue: z.value,
            ...
            (P = e.inputOptions) != null && P.includes("caption") && z.value ? (a(), u(o(M), {
              key: 1,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (a(), u(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (q = e.inputOptions) != null && q.includes("lightbox") ? (a(), u(o(E), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

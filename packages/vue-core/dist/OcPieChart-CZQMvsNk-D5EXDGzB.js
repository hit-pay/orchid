...
import "dayjs";
import { m as O } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { M as S } from "./OcTooltip-HpelzfZG-w8_u6oS8-BWOI0gq2.js";
...
}, _ = { class: "py-2 text-sm text-oc-text-400 font-medium px-3 w-max" }, q = {
  __name: "OcPieChart",
  props: {
    showTooltip: Boolean,
    showLegend: Boolean,
  ...
  setup(p, { expose: w }) {
    ...
    return w({
      ...
      p.showLegend ? (t(), a("div", A, [
        (t(!0), a(i, null, f(m.value.series[0].data, (e) => (t(), h(x(S), {
          key: e.name,
          position: "top",

...
import "dayjs";
import { M as O, D as S } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { p as V } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK.js";
import "echarts";
  ...
  setup(p, { expose: w }) {
    ...
    return w({
      ...
      p.showLegend ? (t(), a("div", N, [
        (t(!0), a(l, null, f(m.value.series[0].data, (e) => (t(), h(x(O), {
          key: e.name,
          position: "top",

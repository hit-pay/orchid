import { ref as s, openBlock as n, createBlock as V, unref as f, withCtx as S, createVNode as y, computed as O, watch as z, onUnmounted as I, createElementBlock as d, createElementVNode as u, normalizeClass as x, renderSlot as g, toDisplayString as k, createCommentVNode as m, mergeProps as C } from "vue";
import "dayjs";
import { g as $, l as B } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import _ from "./OcCropper-DGKAODRX-DXXcDdr6-BoTBE00s-Bxqcs8tz-ZANfthLX-DVfZD7CP-CE2yDtd9-D5ec510n-C-LhM995-C37DnJia--42PvbSx-BYIySsBw-DAU535pT-CQfZhFuR-XtVucyCH-vkXuadbC-CKTviL6N-BpzXrr2O-CxNLcWN_-D2s69fQk.js";
...
const j = {
...
}, P = { class: "flex flex-col gap-y-1 overflow-hidden" }, E = { class: "text-lg font-medium text-ellipsis overflow-hidden whitespace-nowrap" }, N = {
  key: 0,
  ...
  setup(e, { emit: b }) {
    const i = e, l = b, v = () => {
      ...
      l("click:outside"), !i.persistent && i.modelValue && v();
    }, p = () => {
      l("cancel"), v();
    }, h = O(() => ({
      default: "max-w-[640px]",

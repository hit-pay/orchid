...
import { _ as F, z as G } from "./OcTitle-CMEw2BNj.js";
import "dayjs";
...
import { q as V } from "./OcButton-Cnqik19l-BEVE67cg.js";
import { o as q, n as w } from "./OcDropdownItem-CzffqBjG-CMBrNq8k.js";
import { _ as J } from "./OcCopyTooltip.vue_vue_type_script_setup_true_lang-DXxdsDSQ-Cq3XmOXN.js";
...
const X = { class: "flex flex-col gap-y-3" }, Y = { class: "flex items-center justify-between gap-x-3" }, Z = { class: "text-xl leading-[24px] font-medium" }, _ = {
  ...
  setup(t, { emit: l }) {
    ...
    return (v, b) => {
      ...
      return e(), a("div", {
        ...
        (U = t.primaryActions) != null && U.mainLinkAction ? (e(), s(o(S), {
          key: 0,
          position: "top",
          "arrow-hidden": "",
          distance: 7
        ...
        (e(!0), a(B, null, A(t.primaryActions.actions, (n, f) => {
          ...
          return e(), a(B, { key: f }, [
            ...
            u(o(S), {
              ...
              popper: r(() => [
                d("div", at, T(n != null && n.isCopyButton ? i.value ? z.value : j.value : n.tooltipContent), 1)
              ]),
              default: r(() => [
  ...
  setup(t) {
    ...
    return (h, p) => (e(), a("div", dt, [
        ...
        menu: r(() => {
          ...
          return [
            (k = t.secondaryButtonProps) != null && k.dropdownOptions ? (e(), a("div", ut, [
              (e(!0), a(B, null, A(t.secondaryButtonProps.dropdownOptions, (j, z) => (e(), s(o(w), x({
                key: z,
                ref_for: !0
              }, j), null, 16))), 128))
            ])) : c("", !0)
      ...
      t.primaryButtonProps && t.primaryButtonProps.tooltip ? (e(), s(o(S), {
        key: 1,
        position: "top",
        distance: 4,
        "arrow-hidden": ""
...
}, St = /* @__PURE__ */ Q(yt, [["__scopeId", "data-v-d02d5377"]]);
export {
  St as O,
  jt as _,
  zt as a

import { ref as y, watch as P, nextTick as J, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as z, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as L, toDisplayString as N, withModifiers as X, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { t as R, n as W, j as te, l as le, s as Y, $ as q, i as ae, B as F, g as oe } from "./Cropper-CtPTheuH.js";
...
const ne = {
    ...
    return (s, u) => (l(), p(o(Y), {
      ...
      default: V(() => [
        g("div", {
          ...
          onClick: u[5] || (u[5] = (h) => {
            var C;
            return (C = s.$refs.inputRef) == null ? void 0 : C.focus();
          })
        }, [
          ...
          g("div", re, [
            e.isInlineLabel && e.label ? (l(), b("label", se, N(e.label) + ": ", 1)) : r("", !0),
            g("div", ue, [
              e.preFill ? (l(), b("span", pe, N(e.preFill), 1)) : r("", !0),
              g("input", L({
                ref_key: "inputRef",
                ref: x,
                value: e.modelValue,
                ...
                type: $.value && v.value ? "text" : e.inputType,
                onFocus: u[0] || (u[0] = (h) => {
    ...
    return (f, n) => (l(), p(o(ae), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (l(), p(o(oe), ee(L({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
              B(f.$slots, "tooltipText", {}, () => [
                e.tooltipText ? (l(), b("div", ge, N(e.tooltipText), 1)) : r("", !0)
              ])
            ]),
            default: V(() => [
              w(o(F), {
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ke = /* @__PURE__ */ g("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), Ce = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    }, I = y(!!d.value.caption), M = y(!!d.value.lightbox);
    return (i, t) => {
      var O, U, T, j, E, A;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          (U = e.inputOptions) != null && U.includes("link") ? (l(), p(o(D), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (l(), p(o(W), {
              key: 0,
              modelValue: I.value,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && I.value ? (l(), p(o(D), {
              key: 1,
            ...
            (E = e.inputOptions) != null && E.includes("caption") && I.value ? (l(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (A = e.inputOptions) != null && A.includes("lightbox") ? (l(), p(o(W), {
              key: 0,
              modelValue: M.value,
              "onUpdate:modelValue": [

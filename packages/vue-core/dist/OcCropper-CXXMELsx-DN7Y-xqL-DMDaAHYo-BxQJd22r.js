import { ref as y, watch as q, nextTick as Y, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as H, computed as $, createSlots as K, normalizeClass as k, renderSlot as B, mergeProps as T, toDisplayString as L, withModifiers as X, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { aR as R, aS as W, aP as te, aQ as ae, aT as Q, aL as A, aO as le, aG as E, aF as oe } from "./Cropper-CtPTheuH.js";
    ...
    return (s, u) => (a(), p(o(Q), {
      ...
      default: V(() => [
        g("div", {
          ...
          g("div", re, [
            e.isInlineLabel && e.label ? (a(), b("label", se, L(e.label) + ": ", 1)) : r("", !0),
            g("div", ue, [
              e.preFill ? (a(), b("span", pe, L(e.preFill), 1)) : r("", !0),
              g("input", T({
                ref_key: "inputRef",
                ref: x,
                value: e.modelValue,
    ...
    return (f, n) => (a(), p(o(le), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (a(), p(o(oe), ee(T({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
              B(f.$slots, "tooltipText", {}, () => [
                e.tooltipText ? (a(), b("div", ge, L(e.tooltipText), 1)) : r("", !0)
              ])
            ]),
            default: V(() => [
              w(o(E), {
    ...
    return (i, t) => {
      ...
      return a(), b("div", he, [
        ...
        g("div", xe, [
          ...
          (D = e.inputOptions) != null && D.includes("link") ? (a(), p(o(M), {
            key: 1,
          ...
          g("div", null, [
            (N = e.inputOptions) != null && N.includes("caption") ? (a(), p(o(W), {
              key: 0,
              modelValue: I.value,
            ...
            (P = e.inputOptions) != null && P.includes("caption") && I.value ? (a(), p(o(M), {
              key: 1,
          ...
          g("div", null, [
            (F = e.inputOptions) != null && F.includes("lightbox") ? (a(), p(o(W), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

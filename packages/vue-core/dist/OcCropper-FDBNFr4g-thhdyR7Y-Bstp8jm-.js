import { useAttrs as Q, ref as f, computed as $, openBlock as l, createBlock as p, unref as o, createSlots as X, withCtx as V, createElementVNode as g, normalizeClass as k, createElementBlock as b, renderSlot as B, createCommentVNode as r, mergeProps as M, toDisplayString as D, withModifiers as Y, watch as A, nextTick as H, Fragment as G, createVNode as w, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { aV as J, aQ as E, c as C, aX as W, f as te, aT as le, aL as F, aK as ae } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { P as oe } from "./OcTooltip-DBif_2H1-B-R8nPrI-BM5y6FC0-BiGpbzD8.js";
...
const ne = {
  ...
  key: 0,
  class: "text-oc-text-300"
}, de = ["value", "readonly", "placeholder", "disabled", "autocomplete", "inputmode", "type"], L = {
  __name: "OcInput",
  props: {
    disabled: {
      type: Boolean,
        ...
        g("div", {
          ...
          s.$slots.leading || R.value ? (l(), b("div", {
            ...
            s.$slots.leading ? r("", !0) : (l(), b("span", {
              ...
              onClick: u[4] || (u[4] = Y((h) => v.value = !v.value, ["prevent"]))
            }, [
              (l(), p(o(E), {
                key: v.value,
    ...
    return (y, n) => (l(), p(o(le), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (l(), p(o(ae), ee(M({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
...
}, he = { class: "flex flex-col gap-y-5" }, fe = ["src"], ye = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, Ie = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: y }) {
    ...
    }, K = ({ imageSize: i, visibleArea: t }) => ({
      width: (t || i).width,
      height: (t || i).height
    }), _ = (i, t) => {
      let O = d.value;
      O[i] = t, S("update:input-options", O);
    }, z = f(!!d.value.caption), N = f(!!d.value.lightbox);
    return (i, t) => {
      var O, T, U, P, q, j;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (l(), p(o(L), {
            key: 0,
          ...
          (T = e.inputOptions) != null && T.includes("link") ? (l(), p(o(L), {
            key: 1,
          ...
          g("div", null, [
            (U = e.inputOptions) != null && U.includes("caption") ? (l(), p(o(W), {
              key: 0,
              modelValue: z.value,
            ...
            (P = e.inputOptions) != null && P.includes("caption") && z.value ? (l(), p(o(L), {
              key: 1,
            ...
            (q = e.inputOptions) != null && q.includes("caption") && z.value ? (l(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (j = e.inputOptions) != null && j.includes("lightbox") ? (l(), p(o(W), {
              key: 0,
              modelValue: N.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (a) => N.value = a),

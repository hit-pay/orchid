...
import "dayjs";
import { ah as _, ai as B } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import $ from "./OcCropper-DhS0GKUG-CdXEbW8C-BvRSkuT6-BXahjrdc-Bl3pdl7x-CTE3cGyv-C6o3JafI-Ctg9Vvra-CI4evSf7-BjdkE5np.js";
...
}, N = { class: "flex flex-col gap-y-1 overflow-hidden" }, P = { class: "text-lg font-medium text-ellipsis overflow-hidden whitespace-nowrap" }, E = {
  key: 0,
    ...
    return z(
      ...
      u("div", {
        ...
        e.isHeaderVisible ? (n(), d("div", {
          ...
          y(t.$slots, "header", {}, () => [
            u("div", N, [
              u("span", P, k(e.title), 1),
              y(t.$slots, "description", {}, () => [
                e.description ? (n(), d("span", E, k(e.description), 1)) : m("", !0)
              ])
            ]),

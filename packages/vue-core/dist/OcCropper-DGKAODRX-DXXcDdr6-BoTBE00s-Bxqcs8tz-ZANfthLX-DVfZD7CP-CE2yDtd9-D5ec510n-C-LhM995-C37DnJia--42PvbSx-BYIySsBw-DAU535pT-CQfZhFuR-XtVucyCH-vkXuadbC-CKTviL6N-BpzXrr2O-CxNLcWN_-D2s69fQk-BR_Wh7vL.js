import { ref as y, watch as P, nextTick as H, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as J, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as I, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as M, toDisplayString as D, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { X as R, J as W, E as te, L as le, e as X, d as q, b as ae, A as F, k as oe } from "./Cropper-CtPTheuH.js";
    ...
    return (v, m) => (l(), p(o(X), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(J, null, Z(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ke = /* @__PURE__ */ g("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), $e = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
      ...
      return l(), b("div", he, [
        ...
        g("div", xe, [
          ...
          g("div", null, [
            ...
            (A = e.inputOptions) != null && A.includes("caption") && z.value ? (l(), p(o(L), {
              key: 1,
            ...
            (E = e.inputOptions) != null && E.includes("caption") && z.value ? (l(), p(o(ve), {
              key: 2,

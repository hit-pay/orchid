import { defineComponent as te, openBlock as o, createBlock as m, unref as r, mergeProps as b, withCtx as c, createElementVNode as l, toDisplayString as f, renderSlot as v, createVNode as u, computed as T, createElementBlock as a, normalizeClass as x, createTextVNode as B, createCommentVNode as y, Fragment as g, normalizeStyle as re, normalizeProps as S, renderList as h, ref as oe, createSlots as $, Transition as X, guardReactiveProps as Z } from "vue";
import "dayjs";
import { aK as ie, aL as le, d as de, q as G, m as _ } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { _ as ce, z as ue } from "./OcTitle-DfvFV5Yx.js";
import { j as se } from "./OcChip-D-MDc7mX-aGoqgxkI.js";
import { l as O } from "./OcSkeleton-BgoOR1qd-pnPSK-aY.js";
import { q as C } from "./OcButton-CgGNGzWP-CIpgruq1.js";
import { o as me, n as pe } from "./OcDropdownItem-lmVCX47e-KIMNJ0NG.js";
import { q as L } from "./OcTooltip-HpelzfZG-w8_u6oS8.js";
import { R as ye, Y as I } from "./OcOverviewItem-bXigNVA7-DSzO56PR.js";
...
const xe = { class: "px-3 py-2 text-oc-text-400 text-sm font-medium" }, ge = /* @__PURE__ */ te({
  ...
  setup(e, { emit: s }) {
    const i = s;
    return (t, n) => {
      var d, p, w, P, z, V, E, D, H, M, N, q, U, R, Y, F, J, K, Q;
      return o(), a("div", {
            ...
            l("div", be, [
              u(r(ee), {
                ...
                default: c(() => {
                  var k, W;
                  return [
                    B(f(((W = (k = e.customer) == null ? void 0 : k.name) == null ? void 0 : W[0]) || "J"), 1)
                  ];
                }),
                _: 1
              }),
            ...
            e.variant !== "small" ? (o(), a("div", Oe, [
              ...
              e.isBeneficiary ? (o(), m(r(A), {
                ...
                content: [
                  ...
                  ((Y = (R = e.customer) == null ? void 0 : R.address) == null ? void 0 : Y.state) || "",
                  ((J = (F = e.customer) == null ? void 0 : F.address) == null ? void 0 : J.postal_code) || "",
                  ((Q = (K = e.customer) == null ? void 0 : K.address) == null ? void 0 : Q.country) || ""
                ].join(" ").trim() || "-"
              }, null, 8, ["content"]))
            ])) : y("", !0)
...
}, Ue = { class: "flex justify-between md:flex-row flex-col gap-y-3 gap-x-4 md:gap-y-0" }, Re = { key: 2 }, Ye = {
  key: 4,
...
}, Je = { class: "flex flex-col gap-y-5" }, Ke = { class: "flex gap-x-5 overflow-x-auto" }, Qe = {
...
}, We = {}, Xe = { class: "flex gap-x-5 md:flex-nowrap flex-wrap p-3 md:items-center bg-oc-gray-50 border border-oc-gray-200 rounded overflow-hidden" };
function Ze(e, s) {
  return o(), a("div", Xe, [
    v(e.$slots, "default")
  ]);
}
const j = /* @__PURE__ */ ve(We, [["render", Ze]]), Ge = { class: "flex" }, _e = {
  key: 0,
  class: "p-2"
  ...
  setup(e) {
    ...
    return (t, n) => (o(), a("div", lt, [
      ...
      ]), 1032, ["boxes", "customer-card-variant", "customer", "is-customer", "customer-is-hover", "customer-is-edit", "class"])) : e.variant === "balance" ? (o(), m(Qe, {
        key: 2,

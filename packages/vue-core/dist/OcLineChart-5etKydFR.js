      ...
      tooltip: {
        ...
        formatter: (r) => {
          ...
          let x = `<div class="text-oc-text-400 text-sm font-medium flex items-center gap-x-1">
                 <div
                  class="w-0 h-0 rounded-xs border-l-[4px] border-l-transparent border-r-[4px] border-r-transparent ${((s = e.data) == null ? void 0 : s.percent) < 0 ? "border-t-[6px] border-t-oc-error" : "border-b-[6px] border-b-oc-success"}"
                  ></div>

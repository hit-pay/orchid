import { ref as y, watch as P, nextTick as K, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as Z, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Q, computed as z, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as D, toDisplayString as L, withModifiers as J, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { X as R, Z as q, V as te, W as le, a0 as G, Q as A, U as ae, L as F, K as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
    ...
    return (s, u) => (l(), p(o(G), {
      ...
      default: V(() => [
        g("div", {
          ...
          g("div", re, [
            e.isInlineLabel && e.label ? (l(), b("label", se, L(e.label) + ": ", 1)) : r("", !0),
            g("div", ue, [
              e.preFill ? (l(), b("span", pe, L(e.preFill), 1)) : r("", !0),
              g("input", D({
                ref_key: "inputRef",
                ref: x,
                value: e.modelValue,
                ...
                type: O.value && v.value ? "text" : e.inputType,
                onFocus: u[0] || (u[0] = (h) => {
          ...
          s.$slots.leading || O.value ? (l(), b("div", {
            key: 1,
            class: k({
            ...
            s.$slots.leading ? r("", !0) : (l(), b("span", {
              ...
              onClick: u[4] || (u[4] = J((h) => v.value = !v.value, ["prevent"]))
            }, [
              (l(), p(o(A), {
                key: v.value,
    ...
    return (f, n) => (l(), p(o(ae), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (l(), p(o(oe), ee(D({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
              B(f.$slots, "tooltipText", {}, () => [
                e.tooltipText ? (l(), b("div", ge, L(e.tooltipText), 1)) : r("", !0)
              ])
            ]),
            default: V(() => [
              w(o(F), {
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, Oe = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    const O = () => {
      ...
      let C = d.value;
      C[i] = t, S("update:input-options", C);
    }, $ = y(!!d.value.caption), M = y(!!d.value.lightbox);
    return (i, t) => {
      var C, N, T, W, j, E;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          (C = e.inputOptions) != null && C.includes("description") ? (l(), p(o(U), {
            key: 0,
          ...
          (N = e.inputOptions) != null && N.includes("link") ? (l(), p(o(U), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (l(), p(o(q), {
              key: 0,
              modelValue: $.value,
            ...
            (W = e.inputOptions) != null && W.includes("caption") && $.value ? (l(), p(o(U), {
              key: 1,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && $.value ? (l(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (E = e.inputOptions) != null && E.includes("lightbox") ? (l(), p(o(q), {
              key: 0,
              modelValue: M.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (a) => M.value = a),

import { ref as f, onMounted as T, openBlock as m, createElementBlock as o, createElementVNode as s, toDisplayString as d, createCommentVNode as x, normalizeClass as G, normalizeStyle as V, renderSlot as S, createTextVNode as $ } from "vue";
...
const C = { class: "w-full flex flex-wrap" }, B = {
  ...
  setup(e, { expose: I, emit: N }) {
    const t = e, O = N, l = f(), n = f(), p = f(), r = f(0), y = f(0), b = () => {
      var a, i;
...
}, K = /* @__PURE__ */ z(F, [["__scopeId", "data-v-43a77a49"]]);
export {
  K as O
};

import { ref as f, watch as P, nextTick as Z, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as $, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as N, toDisplayString as D, withModifiers as X, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { aH as C, aI as E, aF as te, aG as le, aJ as H, aB as W, aE as ae, aw as A, av as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
...
}, he = { class: "flex flex-col gap-y-5" }, fe = ["src"], ye = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, Re = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: y }) {
    ...
    }, z = f(!!d.value.caption), U = f(!!d.value.lightbox);
    return (i, t) => {
      var O, L, T, j, q, F;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          g("div", null, [
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (l(), p(o(M), {
              key: 1,
          ...
          g("div", null, [
            (F = e.inputOptions) != null && F.includes("lightbox") ? (l(), p(o(E), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

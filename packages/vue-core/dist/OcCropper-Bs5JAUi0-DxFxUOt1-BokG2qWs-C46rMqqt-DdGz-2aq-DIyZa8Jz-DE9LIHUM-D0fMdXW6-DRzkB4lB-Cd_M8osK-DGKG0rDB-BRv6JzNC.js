import { ref as y, watch as P, nextTick as X, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as H, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as I, createSlots as K, normalizeClass as k, renderSlot as B, mergeProps as L, toDisplayString as D, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { a8 as R, a9 as q, a6 as te, a7 as ae, aa as G, a2 as A, a5 as le, W as E, V as oe } from "./Cropper-Qy54pgCV.js";
    ...
    return (v, m) => (a(), p(o(G), {
      ...
      default: V(() => [
        g("div", {
          ...
          (a(!0), b(H, null, Z(e.radio, (c, d) => (a(), p(o(be), {
            id: c.value,
            key: d,
  ...
  setup(e, { emit: f }) {
    ...
    return (i, t) => {
      ...
      return a(), b("div", he, [
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (a(), p(o(M), {
            key: 0,
          ...
          (T = e.inputOptions) != null && T.includes("link") ? (a(), p(o(M), {
            key: 1,
          ...
          g("div", null, [
            (U = e.inputOptions) != null && U.includes("caption") ? (a(), p(o(q), {
              key: 0,
              modelValue: z.value,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (a(), p(o(M), {
              key: 1,
            ...
            (W = e.inputOptions) != null && W.includes("caption") && z.value ? (a(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (F = e.inputOptions) != null && F.includes("lightbox") ? (a(), p(o(q), {
              key: 0,
              modelValue: N.value,
              "onUpdate:modelValue": [

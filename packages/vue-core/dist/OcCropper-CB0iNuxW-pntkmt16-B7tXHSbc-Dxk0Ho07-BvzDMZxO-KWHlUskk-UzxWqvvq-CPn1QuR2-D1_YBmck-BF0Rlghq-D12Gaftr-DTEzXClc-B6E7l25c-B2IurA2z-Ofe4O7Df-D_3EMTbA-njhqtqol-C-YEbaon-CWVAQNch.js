import { ref as y, watch as P, nextTick as K, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as J, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Q, computed as I, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as L, toDisplayString as M, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { u as R, p as W, o as te, A as le, v as G, $ as E, k as ae, g as F, J as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
  ...
  setup(e, { emit: f }) {
    ...
    }, z = y(!!d.value.caption), T = y(!!d.value.lightbox);
    return (i, t) => {
      var O, U, N, A, j, q;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          g("div", null, [
            (N = e.inputOptions) != null && N.includes("caption") ? (l(), p(o(W), {
              key: 0,
              modelValue: z.value,
            ...
            (A = e.inputOptions) != null && A.includes("caption") && z.value ? (l(), p(o(D), {
              key: 1,
          ...
          g("div", null, [
            (q = e.inputOptions) != null && q.includes("lightbox") ? (l(), p(o(W), {
              key: 0,
              modelValue: T.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (a) => T.value = a),

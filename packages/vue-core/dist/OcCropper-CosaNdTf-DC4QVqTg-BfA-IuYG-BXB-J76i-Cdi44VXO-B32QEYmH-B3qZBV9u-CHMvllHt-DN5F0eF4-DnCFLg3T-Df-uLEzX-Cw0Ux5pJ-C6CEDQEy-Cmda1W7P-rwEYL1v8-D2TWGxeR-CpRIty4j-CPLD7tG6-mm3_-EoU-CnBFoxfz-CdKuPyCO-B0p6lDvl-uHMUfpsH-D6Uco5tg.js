import { ref as c, watch as B, nextTick as Z, openBlock as i, createElementBlock as b, createElementVNode as m, createBlock as r, unref as t, Fragment as $, createVNode as s, createCommentVNode as p, withCtx as y } from "vue";
import "dayjs";
import { F as h, Z as I, k as T, A as q } from "./Cropper-CtPTheuH.js";
...
const P = { class: "flex flex-col gap-y-5" }, Q = ["src"], X = { class: "flex gap-x-1 justify-center relative" }, H = { class: "grid grid-cols-2 gap-4" }, K = /* @__PURE__ */ m("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), ne = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(n, { emit: N }) {
    const d = n, x = N, f = c(), w = c(), u = c(""), z = c(!1), o = c(d.inputOptionValues ?? {});
    B(
      () => d.inputOptionValues,
      () => {
    ...
    return (a, e) => {
      ...
      return i(), b("div", P, [
        ...
        m("div", H, [
          ...
          m("div", null, [
            (R = n.inputOptions) != null && R.includes("caption") ? (i(), r(t(I), {
              key: 0,
              modelValue: k.value,
          ...
          m("div", null, [
            (A = n.inputOptions) != null && A.includes("lightbox") ? (i(), r(t(I), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

...
import "dayjs";
import { V, W as O } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { p as S } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK.js";
import "echarts";
  ...
  setup(p, { expose: w }) {
    ...
    return w({
      ...
      p.showLegend ? (t(), a("div", N, [
        (t(!0), a(l, null, f(m.value.series[0].data, (e) => (t(), h(x(V), {
          key: e.name,
          position: "top",

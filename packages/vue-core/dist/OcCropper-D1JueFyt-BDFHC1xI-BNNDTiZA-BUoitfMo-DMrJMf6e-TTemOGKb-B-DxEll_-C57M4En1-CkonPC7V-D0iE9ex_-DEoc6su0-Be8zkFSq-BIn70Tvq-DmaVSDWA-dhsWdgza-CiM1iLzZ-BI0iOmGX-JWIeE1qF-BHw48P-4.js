import { ref as y, watch as q, nextTick as J, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as I, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as D, toDisplayString as L, withModifiers as X, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { G as C, W as A, h as te, $ as le, i as Z, B as P, p as ae, L as F, E as oe } from "./Cropper-CtPTheuH.js";
...
const ne = {
    ...
    return (s, u) => (l(), p(o(Z), {
      ...
      default: V(() => [
        g("div", {
          ...
          onClick: u[5] || (u[5] = (h) => {
            var R;
            return (R = s.$refs.inputRef) == null ? void 0 : R.focus();
          })
        }, [
    ...
    return (v, m) => (l(), p(o(Z), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(G, null, Y(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ke = /* @__PURE__ */ g("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), Re = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    }, z = y(!!d.value.caption), N = y(!!d.value.lightbox);
    return (i, t) => {
      var O, U, T, E, W, j;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (l(), p(o(M), {
            key: 0,
          ...
          (U = e.inputOptions) != null && U.includes("link") ? (l(), p(o(M), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (l(), p(o(A), {
              key: 0,
              modelValue: z.value,
            ...
            (E = e.inputOptions) != null && E.includes("caption") && z.value ? (l(), p(o(M), {
              key: 1,
            ...
            (W = e.inputOptions) != null && W.includes("caption") && z.value ? (l(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (j = e.inputOptions) != null && j.includes("lightbox") ? (l(), p(o(A), {
              key: 0,
              modelValue: N.value,
              "onUpdate:modelValue": [

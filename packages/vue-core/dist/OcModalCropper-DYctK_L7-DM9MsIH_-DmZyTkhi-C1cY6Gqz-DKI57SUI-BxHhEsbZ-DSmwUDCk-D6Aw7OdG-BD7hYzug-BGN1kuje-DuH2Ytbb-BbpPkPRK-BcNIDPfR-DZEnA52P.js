import { ref as s, openBlock as n, createBlock as V, unref as f, withCtx as S, createVNode as g, computed as O, watch as z, onUnmounted as I, createElementBlock as d, createElementVNode as u, normalizeClass as v, renderSlot as y, toDisplayString as C, createCommentVNode as m, mergeProps as k } from "vue";
import "dayjs";
import { V as $, Y as B } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import _ from "./OcCropper-D8Btn88G-CTVBqkrS-DkvNTYf4-COxWGSMz-B1lV_qJ_-BrCyw9fT-Cg8XnIhk-BPFvaM3c-CoStdFZz-DiSLJNUv-C2MB1kN2-D-ssfID2-BU6Wowxw-6qkRqPO0.js";
...
const j = {
  ...
  setup(e, { emit: b }) {
    const a = e, l = b, x = () => {
      ...
      l("click:outside"), !a.persistent && a.modelValue && x();
    }, p = () => {
      l("cancel"), x();
    }, h = O(() => ({
      default: "max-w-[640px]",
    ...
    return z(
      ...
      u("div", {
        ...
        e.isHeaderVisible ? (n(), d("div", {
          ...
          y(t.$slots, "header", {}, () => [
            u("div", P, [
              u("span", E, C(e.title), 1),
              y(t.$slots, "description", {}, () => [
                e.description ? (n(), d("span", N, C(e.description), 1)) : m("", !0)
              ])
            ]),

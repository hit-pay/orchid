import { ref as f, watch as E, nextTick as Z, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as $, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as D, toDisplayString as M, withModifiers as X, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { aH as R, aI as P, aF as te, aG as ae, aJ as J, aB as W, aE as le, aw as A, av as oe } from "./Cropper-CtPTheuH.js";
...
const ne = {
  ...
  key: 0,
  class: "text-oc-text-300"
}, de = ["value", "readonly", "placeholder", "disabled", "autocomplete", "inputmode", "type"], U = {
  __name: "OcInput",
  props: {
    disabled: {
      type: Boolean,
    ...
    return (s, u) => (a(), p(o(J), {
      ...
      default: V(() => [
        g("div", {
          ...
          onClick: u[5] || (u[5] = (h) => {
            var I;
            return (I = s.$refs.inputRef) == null ? void 0 : I.focus();
          })
        }, [
          ...
          g("div", re, [
            e.isInlineLabel && e.label ? (a(), b("label", se, M(e.label) + ": ", 1)) : r("", !0),
            g("div", ue, [
              e.preFill ? (a(), b("span", pe, M(e.preFill), 1)) : r("", !0),
              g("input", D({
                ref_key: "inputRef",
                ref: x,
                value: e.modelValue,
                ...
                type: C.value && v.value ? "text" : e.inputType,
                onFocus: u[0] || (u[0] = (h) => {
    ...
    return (y, n) => (a(), p(o(le), {
      ...
      default: V(() => [
        g("input", {
          ...
          type: "radio",
          onInput: n[0] || (n[0] = (S) => y.$emit("update:modelValue", S.target.value))
        }, null, 40, ce),
        g("label", {
          ...
          e.labelIcon ? (a(), p(o(oe), ee(D({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
              B(y.$slots, "tooltipText", {}, () => [
                e.tooltipText ? (a(), b("div", ge, M(e.tooltipText), 1)) : r("", !0)
              ])
            ]),
            default: V(() => [
              w(o(A), {
    ...
    return (v, m) => (a(), p(o(J), {
      ...
      default: V(() => [
        g("div", {
          ...
          (a(!0), b(G, null, Y(e.radio, (c, d) => (a(), p(o(be), {
            id: c.value,
            key: d,
...
}, he = { class: "flex flex-col gap-y-5" }, fe = ["src"], ye = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, Ce = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: y }) {
    const n = e, S = y, x = f(), v = f(), m = f(""), c = f(!1), d = f(n.inputOptionValues ?? {});
    E(
      () => n.inputOptionValues,
      () => {
    ...
    }, z = f(!!d.value.caption), L = f(!!d.value.lightbox);
    return (i, t) => {
      var O, N, T, F, j, q;
      return a(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (a(), p(o(U), {
            key: 0,
          ...
          (N = e.inputOptions) != null && N.includes("link") ? (a(), p(o(U), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (a(), p(o(P), {
              key: 0,
              modelValue: z.value,
            ...
            (F = e.inputOptions) != null && F.includes("caption") && z.value ? (a(), p(o(U), {
              key: 1,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && z.value ? (a(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (q = e.inputOptions) != null && q.includes("lightbox") ? (a(), p(o(P), {
              key: 0,
              modelValue: L.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (l) => L.value = l),

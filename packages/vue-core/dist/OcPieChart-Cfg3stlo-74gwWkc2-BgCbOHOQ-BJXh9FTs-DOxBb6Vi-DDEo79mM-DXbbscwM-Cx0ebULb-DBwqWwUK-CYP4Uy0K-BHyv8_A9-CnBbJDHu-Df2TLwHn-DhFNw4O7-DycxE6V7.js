...
import "dayjs";
import { P as L, Q as V } from "./Cropper-Qy54pgCV.js";
...
}, $ = { class: "py-2 text-sm text-oc-text-400 font-medium px-3 w-max" }, q = {
  __name: "OcPieChart",
  props: {
    showTooltip: Boolean,
    showLegend: Boolean,
  ...
  setup(d, { expose: w }) {
    ...
    return w({
      ...
      d.showLegend ? (t(), a("div", O, [
        (t(!0), a(l, null, f(m.value.series[0].data, (e) => (t(), h(x(L), {
          key: e.name,
          position: "top",

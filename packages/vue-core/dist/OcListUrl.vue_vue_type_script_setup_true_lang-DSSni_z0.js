import { defineComponent as C, openBlock as s, createElementBlock as i, createElementVNode as t, toDisplayString as u, createBlock as h, unref as r, withCtx as w, createVNode as $, normalizeClass as x, createCommentVNode as d, useSlots as P, renderSlot as p, createTextVNode as M, ref as T, Fragment as S, renderList as k, computed as B, onMounted as j, onBeforeUnmount as I, mergeProps as O, withModifiers as N, normalizeStyle as E, withDirectives as U, vShow as F, resolveDynamicComponent as _, createSlots as q, normalizeProps as W, guardReactiveProps as Y } from "vue";
import H from "dayjs";
import { m as G } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { g as b } from "./OcIcon-CJgBICxh-Cknfoj_m.js";
import { T as R } from "./OcCopyTooltip.vue_vue_type_script_setup_true_lang-WVQMV5PY-CSiaYiz--DB93WtAM.js";
import { o as V } from "./OcDropdownItem-CzffqBjG-CMBrNq8k.js";
import { j as A } from "./OcChip-BiALeB1C-DzQgECL4.js";
import { q as J } from "./OcTooltip-D_IQeXuu-5xiVEQiR.js";
import { q as K } from "./OcButton-Cnqik19l-BEVE67cg.js";
import { _ as Q } from "./OcCopyTooltip.vue_vue_type_script_setup_true_lang-DXxdsDSQ-Cq3XmOXN.js";
...
}, Ne = { class: "text-oc-text-400 flex gap-x-2 items-center text-sm" }, Ee = {
  key: 0,
  class: "flex gap-5"
    ...
    return (o, g) => (s(), i("div", {
      ...
      t("div", Oe, [
        ...
        t("div", Ve, [
          ...
          p(o.$slots, "default", {}, () => [
            e.descriptionIcon || e.description || e.details.length ? (s(), i("div", Ie, [
              t("div", Ne, [
...
}, bt = { class: "flex gap-x-3 text-sm items-center group/url" }, $t = { class: "text-oc-text-400 font-medium shrink-0" }, wt = { class: "break-all" }, Nt = /* @__PURE__ */ C({
  __name: "OcListUrl",
  props: {
    title: String,
    url: String,

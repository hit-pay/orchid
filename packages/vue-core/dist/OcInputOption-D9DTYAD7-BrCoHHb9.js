import { useAttrs as R, ref as c, computed as m, openBlock as r, createBlock as y, unref as g, createSlots as _, withCtx as h, createElementVNode as p, normalizeClass as v, createElementBlock as n, renderSlot as d, createCommentVNode as i, mergeProps as S, toDisplayString as k, withModifiers as M } from "vue";
import "dayjs";
import { m as $ } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { z as V } from "./OcBaseInput-Bc5AUiVI-CDGfnnZp-CyqZk-kF.js";
const L = {
  key: 0,
  class: "border-r border-gray-200 pr-3 py-3"
}, O = { class: "flex flex-1 items-baseline gap-x-2" }, P = {
  key: 0,
  class: "text-oc-text-300"
}, T = { class: "flex items-center gap-x-1 w-full" }, q = {
  key: 0,
  class: "text-oc-text-300"
}, z = ["value", "readonly", "placeholder", "disabled", "autocomplete", "inputmode", "type"], J = {
  __name: "OcInput",
  props: {
    disabled: {
      type: Boolean,
    ...
    return (t, l) => (r(), y(g(V), {
      ...
      default: h(() => [
        p("div", {
          ...
          p("div", O, [
            e.isInlineLabel && e.label ? (r(), n("label", P, k(e.label) + ": ", 1)) : i("", !0),
            p("div", T, [
              ...
              p("input", S({
                ...
                type: f.value && s.value ? "text" : e.inputType,
                onFocus: l[0] || (l[0] = (o) => {
          ...
          t.$slots.leading || f.value ? (r(), n("div", {
            key: 1,
            class: v({
            ...
            t.$slots.leading ? i("", !0) : (r(), n("span", {
              ...
              onClick: l[4] || (l[4] = M((o) => s.value = !s.value, ["prevent"]))
            }, [
              (r(), y(g($), {
                key: s.value,

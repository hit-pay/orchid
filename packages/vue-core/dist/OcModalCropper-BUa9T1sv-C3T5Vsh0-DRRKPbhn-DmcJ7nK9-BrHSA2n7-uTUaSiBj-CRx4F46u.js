...
import "dayjs";
import { aw as j, ax as B } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import E from "./OcCropper-CLY4AFYI-BhawQFjh-BDPRj2v5-CNSoSG6g-BXBfyDq2-C74v4z40-DaPE3Xl2.js";
...
const P = {
  ...
  setup(e, { emit: b }) {
    ...
    return z(
      ...
      u("div", {
        class: v(["z-[1008] shadow-normal w-[calc(100%-40px)] max-h-[96vh] bg-oc-bg-light rounded-xl flex flex-col", w.value[e.size]])
      }, [
        e.isHeaderVisible ? (n(), d("div", {
          ...
          y(t.$slots, "header", {}, () => [
            ...
            e.isCloseIcon ? (n(), d("div", {
              ...
              onClick: o[0] || (o[0] = (h) => t.$emit("update:modelValue", !1))
            }, [
              g(f(j), {
                name: "x",
                width: "20",
        ...
        u("div", {
          ...
          onScroll: o[1] || (o[1] = (h) => l("content-scroll", h))
        }, [
          y(t.$slots, "default")
        ], 42, F),
        e.isFooterVisible ? (n(), d("div", {
          ...
          y(t.$slots, "footer", {}, () => [
            ...
            g(f(B), C({
              ...
              onClick: o[2] || (o[2] = (h) => t.$emit("confirm"))
            }), null, 16)
          ])
        ], 2)) : m("", !0)
      ], 2)

import { ref as y, watch as A, nextTick as K, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Q, computed as z, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as D, toDisplayString as M, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { w as C, y as P, u as te, I as le, C as J, l as W, s as ae, $ as F, h as oe } from "./Cropper-CtPTheuH.js";
...
}, ve = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ke = /* @__PURE__ */ g("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), Ie = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    return (i, t) => {
      ...
      return l(), b("div", ve, [
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (l(), p(o(U), {
            key: 0,
          ...
          g("div", null, [
            ...
            (j = e.inputOptions) != null && j.includes("caption") && $.value ? (l(), p(o(U), {
              key: 1,
            ...
            (E = e.inputOptions) != null && E.includes("caption") && $.value ? (l(), p(o(he), {
              key: 2,
          ...
          g("div", null, [
            (q = e.inputOptions) != null && q.includes("lightbox") ? (l(), p(o(P), {
              key: 0,
              modelValue: L.value,
              "onUpdate:modelValue": [

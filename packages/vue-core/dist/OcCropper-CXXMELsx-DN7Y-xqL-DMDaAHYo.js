import { useAttrs as X, ref as y, computed as $, openBlock as l, createBlock as p, unref as o, createSlots as J, withCtx as V, createElementVNode as g, normalizeClass as k, createElementBlock as b, renderSlot as B, createCommentVNode as r, mergeProps as L, toDisplayString as D, withModifiers as K, watch as W, nextTick as Y, Fragment as G, createVNode as w, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { aQ as H, aL as j, n as C, aS as A, d as te, aO as le, aG as E, aF as ae } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { P as oe } from "./OcTooltip-CbCuSC-i-BesS9FFw-CiDM-om2-BFt7BH9u.js";
        ...
        g("div", {
          ...
          s.$slots.leading || R.value ? (l(), b("div", {
            ...
            s.$slots.leading ? r("", !0) : (l(), b("span", {
              ...
              onClick: u[4] || (u[4] = K((v) => h.value = !h.value, ["prevent"]))
            }, [
              (l(), p(o(j), {
                key: h.value,
    ...
    return (f, n) => (l(), p(o(le), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (l(), p(o(ae), ee(L({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
...
}, ve = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ze = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
      ...
      return l(), b("div", ve, [
        ...
        g("div", xe, [
          ...
          g("div", null, [
            ...
            (P = e.inputOptions) != null && P.includes("caption") && I.value ? (l(), p(o(U), {
              key: 1,
            ...
            (F = e.inputOptions) != null && F.includes("caption") && I.value ? (l(), p(o(he), {
              key: 2,
          ...
          g("div", null, [
            (q = e.inputOptions) != null && q.includes("lightbox") ? (l(), p(o(A), {
              key: 0,
              modelValue: M.value,
              "onUpdate:modelValue": [

import { computed as b, ref as F, openBlock as t, createElementBlock as a, createElementVNode as n, Fragment as l, renderList as f, createBlock as h, unref as x, withCtx as y, normalizeClass as C, normalizeStyle as L, toDisplayString as s, createTextVNode as g, createCommentVNode as T } from "vue";
import "dayjs";
import { E as B, L as V } from "./Cropper-CtPTheuH.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { m as S } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq.js";
import "echarts";
  ...
  setup(m, { expose: w }) {
    ...
    return w({
      ...
      m.showLegend ? (t(), a("div", N, [
        (t(!0), a(l, null, f(p.value.series[0].data, (e) => (t(), h(x(B), {
          key: e.name,
          position: "top",
          ...
          default: y(() => [
            n("div", {
              ...
              n("div", {
                ...
                style: L({ background: e.itemStyle.color })
              }, null, 4),
              e.icon ? (t(), h(x(V), {
                key: 0,
                name: e.icon,
                width: "32",
                height: "32"
              }, null, 8, ["name"])) : (t(), a("div", E, s(e.name), 1))
            ], 10, O)
          ]),
          popper: y(() => [
            n("div", _, [

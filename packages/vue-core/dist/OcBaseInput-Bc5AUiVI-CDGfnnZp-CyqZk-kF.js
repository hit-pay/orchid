import { openBlock as t, createElementBlock as o, normalizeClass as c, createElementVNode as m, createTextVNode as a, toDisplayString as s, createCommentVNode as l, createBlock as x, unref as n, normalizeProps as d, mergeProps as g, withCtx as p, renderSlot as i, createVNode as f } from "vue";
import "dayjs";
import { d as u } from "./Cropper-Qy54pgCV.js";
  ...
  setup(e) {
    return (r, T) => (t(), o("div", h, [
      e.label ? (t(), o("label", {
        ...
        e.labelIcon ? (t(), x(n(b), d(g({ key: 0 }, e.tooltipOptions)), {
          popper: p(() => [

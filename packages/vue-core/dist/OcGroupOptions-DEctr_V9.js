...
import { j as W } from "./OcChip-BiALeB1C-DzQgECL4.js";
import { l as ie } from "./OcSkeleton-BgoOR1qd-pnPSK-aY.js";
import { z as ne } from "./OcBaseInput-B-eZowCe-M_QvuaZV.js";
import { q as re } from "./OcButton-Cnqik19l-BEVE67cg.js";
import { d as H } from "./OcInputOption-rY2kKCL8-Ce2jETq4.js";
import { q as G } from "./OcGroupOptions-Csf747ZA-DCT2B_pB.js";
import { o as ue } from "./OcDropdownItem-CzffqBjG-CMBrNq8k.js";
import { E as de } from "./OcCheckbox-CPEV7kEq-UN7b0C93.js";
const ce = {
  key: 0,
  ...
  setup(e, { expose: $, emit: C }) {
    const a = e, d = C, f = h(a.searchKeywords ?? ""), x = h(!1), T = h(), D = h(), N = h([]), q = h(), K = h((/* @__PURE__ */ new Date()).toISOString()), A = I(() => {
      var t, l;
    ...
    const j = h("100%"), X = I(() => ({ maxWidth: j.value })), Y = () => {
      ...
      d("toggle"), j.value = (l = (t = R.value) == null ? void 0 : t.$el) != null && l.offsetWidth ? `${(s = (o = R.value) == null ? void 0 : o.$el) == null ? void 0 : s.offsetWidth}px` : "100%", setTimeout(() => {
        ...
        q.value.parentNode.scrollTo(0, L - 60, { behavior: "smooth" });
      }, 10);
    }, Z = (t) => {
      var o, s, r;
      if (a.isLoading)

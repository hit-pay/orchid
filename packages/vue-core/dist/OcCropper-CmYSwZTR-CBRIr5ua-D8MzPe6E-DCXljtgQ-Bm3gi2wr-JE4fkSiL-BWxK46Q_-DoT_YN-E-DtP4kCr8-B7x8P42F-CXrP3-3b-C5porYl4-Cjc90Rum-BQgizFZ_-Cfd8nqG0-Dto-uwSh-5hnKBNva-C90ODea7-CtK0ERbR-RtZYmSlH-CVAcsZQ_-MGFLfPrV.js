...
import "dayjs";
import { c as h, e as $, b as F, B as H } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { U as x, K as M } from "./OcRadioGroup-55qW3h1q-vUnqQg0t-D2Cy6q6G-B1BFhFhM-Bj5QFVCi-BoHTOSZM-DexD99er-DLZvIVEp-X9yvKp_y-DK_nHfmE-CM5Q_jJg-C3nLwy_v-ArXxkLDs-BnAuxZQQ-DtUj7VJf-CAmWiQuM-xyxDb97m-qnIojfvx-6LRhk12f-gwv7FXUM-CQSZgr0J-DThn6BgA-BNzBmfu4.js";
import { Cropper as T } from "vue-advanced-cropper";
const X = { class: "flex flex-col gap-y-5" }, Z = ["src"], G = { class: "flex gap-x-1 justify-center relative" }, J = { class: "grid grid-cols-2 gap-4" }, P = /* @__PURE__ */ m("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), ne = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(n, { emit: j }) {
    const d = n, V = j, f = c(), w = c(), u = c(""), z = c(!1), o = c(d.inputOptionValues ?? {});
    I(
      () => d.inputOptionValues,
      () => {
    ...
    return (a, e) => {
      ...
      return i(), b("div", X, [
        ...
        m("div", J, [
          ...
          m("div", null, [
            (R = n.inputOptions) != null && R.includes("caption") ? (i(), r(t($), {
              key: 0,
              modelValue: k.value,
            ...
            (L = n.inputOptions) != null && L.includes("caption") && k.value ? (i(), r(t(M), {
              key: 2,
          ...
          m("div", null, [
            (B = n.inputOptions) != null && B.includes("lightbox") ? (i(), r(t($), {
              key: 0,
              modelValue: U.value,
              "onUpdate:modelValue": [

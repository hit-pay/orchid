import { ref as y, watch as W, nextTick as J, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as K, computed as z, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as N, toDisplayString as M, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { H as R, O as q, M as te, D as le, S as H, I as A, C as ae, l as F, j as oe } from "./Cropper-CtPTheuH.js";
    ...
    return (i, t) => {
      ...
      return l(), b("div", he, [
        ...
        g("div", xe, [
          ...
          (T = e.inputOptions) != null && T.includes("link") ? (l(), p(o(D), {
            key: 1,
          ...
          g("div", null, [
            (U = e.inputOptions) != null && U.includes("caption") ? (l(), p(o(q), {
              key: 0,
              modelValue: $.value,
          ...
          g("div", null, [
            (P = e.inputOptions) != null && P.includes("lightbox") ? (l(), p(o(q), {
              key: 0,
              modelValue: L.value,
              "onUpdate:modelValue": [

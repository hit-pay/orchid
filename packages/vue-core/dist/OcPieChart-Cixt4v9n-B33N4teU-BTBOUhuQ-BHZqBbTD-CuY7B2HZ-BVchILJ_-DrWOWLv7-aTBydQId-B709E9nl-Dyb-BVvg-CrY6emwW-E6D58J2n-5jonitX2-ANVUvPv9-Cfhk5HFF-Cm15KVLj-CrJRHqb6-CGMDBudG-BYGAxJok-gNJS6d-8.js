...
import "dayjs";
import { _, $ } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import { p as O } from "./useChart-D7VZPAAA-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK-AMoaYUuq-CRMQQGuK.js";
import "echarts";
const S = { class: "flex flex-col items-center" }, V = {
  key: 0,
  class: "flex gap-x-5"
}, L = ["onClick"], N = {
  key: 1,
  ...
  setup(p, { expose: w }) {
    ...
    return w({
      ...
      p.showLegend ? (t(), a("div", V, [
        (t(!0), a(l, null, f(d.value.series[0].data, (e) => (t(), h(x(_), {
          key: e.name,
          position: "top",

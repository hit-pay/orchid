import { ref as y, watch as F, nextTick as H, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as J, computed as z, createSlots as X, normalizeClass as k, renderSlot as B, mergeProps as U, toDisplayString as L, withModifiers as Y, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { R as C, S as W, P as te, Q as le, U as K, L as q, O as ae, F as A, E as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
    ...
    return (f, n) => (l(), p(o(ae), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (l(), p(o(oe), ee(U({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
  ...
  setup(e, { emit: f }) {
    ...
    }, $ = y(!!d.value.caption), D = y(!!d.value.lightbox);
    return (i, t) => {
      var O, N, T, j, E, P;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          (N = e.inputOptions) != null && N.includes("link") ? (l(), p(o(M), {
            key: 1,
          ...
          g("div", null, [
            (P = e.inputOptions) != null && P.includes("lightbox") ? (l(), p(o(W), {
              key: 0,
              modelValue: D.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (a) => D.value = a),

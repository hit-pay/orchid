import { ref as f, watch as A, nextTick as K, openBlock as a, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Z, computed as I, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as U, toDisplayString as M, withModifiers as X, renderList as Y, normalizeProps as ee } from "vue";
import "dayjs";
import { aM as R, aN as F, aK as te, aL as ae, aO as H, aG as W, aJ as le, aB as E, aA as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
    ...
    return (y, n) => (a(), p(o(le), {
      ...
      default: V(() => [
        ...
        g("label", {
          ...
          e.labelIcon ? (a(), p(o(oe), ee(U({ key: 2 }, e.tooltipOptions)), {
            popper: V(() => [
  ...
  setup(e, { emit: y }) {
    ...
    }, $ = f(!!d.value.caption), D = f(!!d.value.lightbox);
    return (i, t) => {
      var O, L, T, q, j, P;
      return a(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          (O = e.inputOptions) != null && O.includes("description") ? (a(), p(o(N), {
            key: 0,
          ...
          (L = e.inputOptions) != null && L.includes("link") ? (a(), p(o(N), {
            key: 1,
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (a(), p(o(F), {
              key: 0,
              modelValue: $.value,
              "onUpdate:modelValue": t[8] || (t[8] = (l) => $.value = l),
              label: "Caption",
              class: "mb-4"
            }, null, 8, ["modelValue"])) : r("", !0),
            (q = e.inputOptions) != null && q.includes("caption") && $.value ? (a(), p(o(N), {
              key: 1,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && $.value ? (a(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (P = e.inputOptions) != null && P.includes("lightbox") ? (a(), p(o(F), {
              key: 0,
              modelValue: D.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (l) => D.value = l),

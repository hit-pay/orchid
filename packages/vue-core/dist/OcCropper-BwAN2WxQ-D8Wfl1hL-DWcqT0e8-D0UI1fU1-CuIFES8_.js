import { ref as y, watch as A, nextTick as Y, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as G, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as Z, computed as I, createSlots as H, normalizeClass as k, renderSlot as B, mergeProps as M, toDisplayString as D, withModifiers as Q, renderList as X, normalizeProps as ee } from "vue";
import "dayjs";
import { aM as C, aN as W, aK as te, aL as le, aO as J, aG as E, aJ as ae, aB as F, aA as oe } from "./Cropper-CtPTheuH.js";
        ...
        g("div", {
          ...
          s.$slots.leading || R.value ? (l(), b("div", {
            ...
            s.$slots.leading ? r("", !0) : (l(), b("span", {
              ...
              onClick: u[4] || (u[4] = Q((v) => h.value = !h.value, ["prevent"]))
            }, [
              (l(), p(o(E), {
                key: h.value,
    ...
    return (h, m) => (l(), p(o(J), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(G, null, X(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
      ...
      return l(), b("div", ve, [
        ...
        g("div", xe, [
          ...
          g("div", null, [
            ...
            (j = e.inputOptions) != null && j.includes("caption") && $.value ? (l(), p(o(L), {
              key: 1,
            ...
            (P = e.inputOptions) != null && P.includes("caption") && $.value ? (l(), p(o(he), {
              key: 2,

import { ref as y, watch as F, nextTick as K, openBlock as l, createElementBlock as b, createElementVNode as g, createBlock as p, unref as o, Fragment as Y, createVNode as w, createCommentVNode as r, withCtx as V, useAttrs as H, computed as z, createSlots as Q, normalizeClass as k, renderSlot as B, mergeProps as N, toDisplayString as D, withModifiers as X, renderList as Z, normalizeProps as ee } from "vue";
import "dayjs";
import { M as R, N as P, K as te, L as le, O as G, F as W, I as ae, Y as q, w as oe } from "./Cropper-Qy54pgCV.js";
...
const ne = {
    ...
    return (s, u) => (l(), p(o(G), {
      ...
      default: V(() => [
        g("div", {
          ...
          s.$slots.leading || C.value ? (l(), b("div", {
            key: 1,
            class: k({
    ...
    return (v, m) => (l(), p(o(G), {
      ...
      default: V(() => [
        g("div", {
          ...
          (l(!0), b(Y, null, Z(e.radio, (c, d) => (l(), p(o(be), {
            id: c.value,
            key: d,
...
}, he = { class: "flex flex-col gap-y-5" }, ye = ["src"], fe = { class: "flex gap-x-1 justify-center relative" }, xe = { class: "grid grid-cols-2 gap-4" }, ke = /* @__PURE__ */ g("div", { class: "text-oc-text-400 text-sm px-3 py-2 font-medium text-center" }, " Show lightbox when click the image ", -1), Ie = {
  __name: "OcCropper",
  props: {
    inputOptions: Array,
  ...
  setup(e, { emit: f }) {
    ...
    }, $ = y(!!d.value.caption), L = y(!!d.value.lightbox);
    return (i, t) => {
      var O, U, T, j, E, A;
      return l(), b("div", he, [
        g("input", {
        ...
        g("div", xe, [
          ...
          g("div", null, [
            (T = e.inputOptions) != null && T.includes("caption") ? (l(), p(o(P), {
              key: 0,
              modelValue: $.value,
            ...
            (j = e.inputOptions) != null && j.includes("caption") && $.value ? (l(), p(o(M), {
              key: 1,
            ...
            (E = e.inputOptions) != null && E.includes("caption") && $.value ? (l(), p(o(ve), {
              key: 2,
          ...
          g("div", null, [
            (A = e.inputOptions) != null && A.includes("lightbox") ? (l(), p(o(P), {
              key: 0,
              modelValue: L.value,
              "onUpdate:modelValue": [
                t[12] || (t[12] = (a) => L.value = a),

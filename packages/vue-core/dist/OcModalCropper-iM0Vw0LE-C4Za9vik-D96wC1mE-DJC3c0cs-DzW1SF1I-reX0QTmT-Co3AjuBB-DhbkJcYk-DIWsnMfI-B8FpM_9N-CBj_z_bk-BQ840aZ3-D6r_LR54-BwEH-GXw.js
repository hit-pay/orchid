...
import "dayjs";
import { Q as j, R as B } from "./Cropper-Qy54pgCV.js";
import "libphonenumber-js";
import "v-calendar";
import "vue-draggable-next";
import "@popperjs/core";
import _ from "./OcCropper-DPrOl1N7-fgjyY1ph-Cmdf9QRA-Qle94W6X-Zu_tOVNS-xdh4wefD-DXFc2PQA-Ck1A3m4a-BBHSGLdK-f6gXCp75-Bf4xhEfD-sntfX45R-SG7rOCp1-7_I1sCkW.js";
...
}, $ = { class: "flex flex-col gap-y-1 overflow-hidden" }, N = { class: "text-lg font-medium text-ellipsis overflow-hidden whitespace-nowrap" }, P = {
  key: 0,
    ...
    return O(
      ...
      u("div", {
        ...
        e.isHeaderVisible ? (n(), d("div", {
          ...
          y(t.$slots, "header", {}, () => [
            u("div", $, [
              u("span", N, k(e.title), 1),
              y(t.$slots, "description", {}, () => [
                e.description ? (n(), d("span", P, k(e.description), 1)) : m("", !0)
              ])
            ]),

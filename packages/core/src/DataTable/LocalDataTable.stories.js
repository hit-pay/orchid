...
export const Default = {
  args: {
    options: {
      searchableFields: ['name', 'status', 'created_at'],
      filterableFields: ['name', 'status', 'available_quantity', 'available', 'keywords'],
      sortableFields: ['created_at', 'name', 'amount'],
      pagination: {
        total: 50,
        last_page: 5
      },
      ...
      const fieldData = [
        {
          ...
          category_id: [
            {
              ...
              pos_color: null,
              description:
                '<p><span style="font-size: 14px;">Loremmm das dasmndas dasjda dasdas</span></p>',
              active: true,
              order: 1,
              total_products: 1,
          ...
          images: [],
          image:
            'http://127.0.0.1:9001/test-bucket/product-variations/screenshot-2025-04-25-at-11-01-19-680b16840641b.png',
          is_published: true,
        ...
        },
        {
          ...
          image:
            'http://127.0.0.1:9001/test-bucket/products/screenshot-2025-04-18-at-17-02-46-680b16e32b080.png',
          is_published: true,
      ...
      const formatFieldData = (data) => {
        return data.map((item) => {
          ...
          return {
            ...
            available:
              item.available || item.quantity > 0 || item.allow_back_order || !item.is_manageable,

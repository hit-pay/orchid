...
export const ExpandingTableStory = {
  ...
  render: (args) => ({
    components: { Theme, ExpandingTable },
    setup() {
      const headers = [
        {
          key: 'gross_sales',
      ...
      const headers2 = [
        { label: 'Header 1', key: 'key1' },
        { label: 'Header 2', key: 'key2' },
        { label: 'Header 3', key: 'key3' },
        { label: 'Header 4', key: 'key4' },
        { label: 'Header 5', key: 'key5' },
        { label: 'Header 6', key: 'key6' }
      ]
      const fields2 = [{ key1: '1', key2: '2' }]
      return { args, fields2, headers, fields, headers2 }
    },
    template: `
      <Theme>
        <div class="p-10">
